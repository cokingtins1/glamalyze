...
export async function POST(req: Request) {
	...
	const data = {
		filteredShared: [
			{
				id: "6211254c-76b1-4f9b-82e7-9cae4e7d8666",
				created_at: new Date("2024-04-30T18:42:53.896Z"),
				updated_at: new Date("2024-05-16T23:46:01.452Z"),
				similarity_score: 1,
				ulta_product_name: "Industrial Strength Hand Healer",
				sephora_product_name: "Industrial Strength Hand Healer",
				ulta_product_id: "e0880ff2-8806-4651-b0e8-bf0840e344bf",
				sephora_product_id: "a10d8294-2774-4d23-88b1-9b36fef151d5",
				brand_id: "a56b7b5c-8bbe-4bf2-9912-8847e63db656",
				brand_name: "Jack Black",
				sephora_avg_rating: 93.254,
				...
				sephora_product_price_range: [16, 48],
				ulta_product_price_range: [48],
				sephora_product_price: 48,
				ulta_product_price: 48,
			},
		],
		filteredUlta: [
			{
